/** Sol menü (spec §90). `phase` > 1 olan bölümler henüz geliştirilmedi ve "Faz N" etiketiyle gösterilir. */
export const NAV_ITEMS = [
  { href: "/dashboard", label: "Dashboard", icon: "LayoutDashboard", phase: 1 },
  { href: "/assistant", label: "AI Assistant", icon: "Sparkles", phase: 4 },
  { href: "/leads", label: "Leads", icon: "Building2", phase: 2 },
  ...
  { href: "/signals", label: "Signals", icon: "Radar", phase: 2 },
